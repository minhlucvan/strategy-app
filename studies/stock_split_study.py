...
def run(symbol_benchmark, symbolsDate_dict):
    ...
    events_df = get_stocks_events(symbolsDate_dict, 'stockDividend')

    dividend_threshold = st.number_input('Dividend Threshold', min_value=0.0, max_value=100.0, value=1.0)
